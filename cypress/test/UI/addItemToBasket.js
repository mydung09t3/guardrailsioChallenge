...
describe("Add One Item to Basket and add  new address", ()=>{
    ...
    beforeEach("Open the page", ()=>{
        ...
        cy.fixture('addressInformation').as('address');
    })
    ...
    it("Add 1 item to cart and add new Address", function() {
        ...
        cy.fillAddress(this.address.country, this.address.name, this.address.mobileNumber, this.address.zipCode, this.address.address,this.address.city,this.address.state);
    ...
    it("Add 2 item to cart and add new Address", function() {
        cy.log("Add item to basket");
        cy.addItemToBasket('Apple Juice (1000ml)');
